...
export default function ADF001() {
  ...
  const defaultRoles = [
    {
      ...
      age: 28,
      height: "185cm",
      appearance: "运动员体型，左臂明显刀疤，锐利眼神，短黑发，废土作战服",
    ...
    },
    {
      ...
      age: 26,
      height: "170cm",
      appearance: "黑色长发，坚韧眼神，废土战术服，身材匀称",
    ...
    },
    {
      ...
      age: 45,
      height: "178cm",
      appearance: "胡须花白，独眼，机械义肢，沧桑废土装",
      personality: "经验丰富、话少、可靠",
      currentGoal: "守护幸存者营地",
      finalGoal: "找到末日真相",
      weakness: "身体伤病"
    }
  ...
  a.href = url;
  a.download = `ADF_角色圣经_${new Date().toISOString().slice(0,10)}.md`;
  a.click();
